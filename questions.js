const questions = [
  {
  question: "21. Max Weber est connu pour :",
  options: [
...
{
  question: "22. La méthode compréhensive vise à :",
  options: [
    "Expliquer par les causes biologiques",
    "Comprendre le sens des actions sociales",
    "Analyser les statistiques uniquement",
    "Interpréter les motivations individuelles",
    "Étudier les lois naturelles"
  ],
  correct: [1,3]
},
{
  question: "23. L’action sociale selon Weber est :",
  options: [
...
{
  question: "24. Karl Marx analyse la société à partir :",
  options: [
...
{
  question: "25. La lutte des classes oppose principalement :",
  options: [
...
{
  question: "26. L’infrastructure selon Marx correspond :",
  options: [
    "À l’économie",
...
{
  question: "27. La superstructure comprend :",
  options: [
    "L’économie",
    "Le droit",
    "La politique",
...
{
  question: "28. Le matérialisme historique affirme que :",
  options: [
    "Les idées dirigent l’histoire",
    "L’économie influence la société",
    "Les conditions matérielles sont déterminantes",
    "La religion est centrale",
    "Les rapports sociaux évoluent historiquement"
  ],
  correct: [1,2,4]
},
{
  question: "29. La stratification sociale désigne :",
  options: [
    "La hiérarchie sociale",
    "Les inégalités sociales",
    "La division biologique",
...
{
  question: "30. Une classe sociale se définit par :",
  options: [
    "Le revenu",
    "La position économique",
    "Le mode de vie",
    "La relation aux moyens de production",
    "L’âge"
  ],
  correct: [1,3]
},
{
  question: "31. La mobilité sociale est :",
  options: [
    "Le changement de position sociale",
    "Toujours ascendante",
    "Verticale ou horizontale",
    "Un phénomène individuel et collectif",
    "Une immobilité sociale"
  ],
  correct: [0,2,3]
},
{
  question: "32. La socialisation primaire se fait surtout par :",
  options: [
    "L’école",
    "La famille",
    "Les médias",
...
{
  question: "33. La socialisation secondaire intervient :",
  options: [
    "À l’enfance uniquement",
    "À l’âge adulte",
...
{
  question: "34. Les normes sociales sont :",
  options: [
...
{
  question: "35. Les valeurs sociales représentent :",
  options: [
    "Ce qui est jugé souhaitable",
    "Des idéaux collectifs",
    "Des lois juridiques",
    "Des principes partagés",
    "Des instincts biologiques"
  ],
  correct: [0,1,3]
},
{
  question: "36. La déviance sociale est :",
  options: [
    "Un comportement conforme",
    "Une transgression des normes",
    "Relative au contexte social",
    "Toujours criminelle",
    "Socialement définie"
  ],
  correct: [1,2,4]
...
{
  question: "37. Le contrôle social vise à :",
  options: [
    "Renforcer les normes",
    "Sanctionner les comportements",
    "Maintenir l’ordre social",
    "Éliminer toute liberté",
    "Réguler les conduites"
  ],
  correct: [0,1,2,4]
},
{
  question: "38. Les sanctions sociales peuvent être :",
  options: [
    "Positives",
    "Négatives",
    "Formelles",
...
{
  question: "39. La culture comprend :",
  options: [
    "Les normes",
    "Les valeurs",
    "Les symboles",
...
{
  question: "40. La sociologie du droit étudie :",
  options: [
...
{
  question: "2. La sociologie étudie principalement :",
  options: [
...
{
  question: "3. Le fondateur de la sociologie est :",
  options: [
    "Karl Marx",
    "Max Weber",
    "Auguste Comte",
...
{
  question: "4. Pour Auguste Comte, la sociologie est aussi appelée :",
  options: [
    "Psychologie sociale",
    "Physique sociale",
    "Anthropologie",
...
{
  question: "5. Un fait social selon Durkheim est :",
  options: [
...
{
  question: "6. Les faits sociaux existent :",
  options: [
    "Avant l’individu",
    "Après l’individu",
    "Indépendamment de l’individu",
    "Seulement dans l’individu",
    "Dans la conscience collective"
  ],
  correct: [0,2,4]
},
{
  question: "7. La conscience collective est :",
  options: [
    "L’ensemble des croyances communes",
...
{
  question: "8. Pour Durkheim, la société :",
  options: [
    "S’impose aux individus",
    "Est créée uniquement par l’individu",
    "Influence les comportements",
    "N’a aucun pouvoir",
    "Est supérieure à l’individu"
  ],
  correct: [0,2,4]
},
{
  question: "9. Le suicide selon Durkheim est :",
  options: [
    "Un acte purement individuel",
    "Un fait social",
    "Influencé par la société",
    "Uniquement psychologique",
    "Mesurable statistiquement"
  ],
  correct: [1,2,4]
},
{
  question: "10. Le suicide égoïste est causé par :",
  options: [
    "Une faible intégration sociale",
    "Un excès d’intégration",
    "Un isolement social",
...
{
  question: "11. Le suicide altruiste est causé par :",
  options: [
    "Un excès d’intégration sociale",
    "Une forte pression du groupe",
    "Un individualisme excessif",
    "Un attachement excessif au groupe",
    "Une absence de normes"
  ],
  correct: [0,1,3]
},
{
  question: "12. Le suicide anomique est lié à :",
  options: [
    "Une crise sociale",
...
{
  question: "14. La méthode sociologique consiste à :",
  options: [
    "Observer les faits sociaux",
    "Traiter les faits sociaux comme des choses",
    "Interpréter subjectivement",
    "Utiliser des statistiques",
    "Éviter toute opinion personnelle"
  ],
  correct: [0,1,3,4]
},
{
  question: "15. Traiter les faits sociaux comme des choses signifie :",
  options: [
    "Les étudier objectivement",
    "Éviter les préjugés",
    "Les juger moralement",
    "Les analyser scientifiquement",
    "Les considérer comme naturels"
  ],
  correct: [0,1,3]
},
{
  question: "16. La sociologie est différente de la psychologie car elle étudie :",
  options: [
    "Le groupe",
    "La société",
    "L’individu isolé",
...
{
  question: "17. Une institution sociale est :",
  options: [
...
{
  question: "18. La famille est :",
  options: [
    "Une institution sociale",
    "Un fait biologique uniquement",
    "Un groupe social",
    "Un fait social",
...
{
  question: "19. L’éducation selon Durkheim est :",
  options: [
    "Un moyen de socialisation",
    "Une transmission des valeurs",
    "Un processus individuel",
    "Un fait social",
    "Une action de la société sur l’individu"
  ],
  correct: [0,1,3,4]
},
{
  question: "20. La socialisation est :",
  options: [
    "L’apprentissage des normes",
    "L’intégration à la société",
    "Un processus continu",
    "Un phénomène individuel uniquement",
    "Un mécanisme social"
  ],
  correct: [0,1,2,4]
},
